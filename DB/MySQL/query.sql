...
DROP TABLE LectureInstructor;
DROP TABLE BookReviewbook;
DROP TABLE InstructorReviewInstructor;
DROP TABLE reviewInstructors;
DROP TABLE UserReviewbook;
DROP TABLE UserReviewInstructor;
DROP TABLE reviewBooks;
DROP TABLE LectureReviewLecture;
DROP TABLE reviewLectures;
DROP TABLE UserReviewLecture;
DROP TABLE reviews;
DROP TABLE BookReviewBook;
DROP TABLE UserReviewBook;
